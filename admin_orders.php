...
<section class="orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Người Dùng id : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('Bạn có muốn xóa đơn đặt hàng này!');" class="delete-btn">Xóa</a>
         </form>
      </div>
      <?php
         }
