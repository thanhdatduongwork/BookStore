...
<section class="products" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="price"><?php echo $fetch_product['price']; ?>.000 VNĐ</div>
   ...
   <?php
            ...
            echo '<p class="empty">Không thể tìm thấy sản phẩm!</p>';
         }
      }else{
         echo '<p class="empty">Bạn có thể tìm kiếm sản phẩm ở đây!</p>';
      }
   ?>
   </div>
