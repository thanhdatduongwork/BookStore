...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="price"><?php echo $fetch_cart['price']; ?>.000 VNĐ</div>
         <form action="" method="post">
            <input type="hidden" name="cart_id" value="<?php echo $fetch_cart['id']; ?>">
            <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
            <input type="submit" name="update_cart" value="Cập Nhật" class="option-btn">
         </form>
         <div class="sub-total"> Giá Tiền : <span><?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>.000 VNĐ</span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>Tổng tiền : <span><?php echo $grand_total; ?>.000 VNĐ</span></p>
      <div class="flex">
